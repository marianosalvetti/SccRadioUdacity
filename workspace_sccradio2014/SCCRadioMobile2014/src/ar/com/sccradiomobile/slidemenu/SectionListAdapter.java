...
public class SectionListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,View convertView, ViewGroup parent) {
        ...
        RobotoTextView textView = (RobotoTextView) convertView.findViewById(R.id.slidingmenu_section_title);
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        RobotoTextView textView = (RobotoTextView) convertView.findViewById(R.id.slidingmenu_sectionitem_label);
