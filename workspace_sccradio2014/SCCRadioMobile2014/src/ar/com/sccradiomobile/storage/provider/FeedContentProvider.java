...
import ar.com.sccradiomobile.databases.FeedDatabaseHelper;
...
public class FeedContentProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "ar.com.sccradiomobile.feedsprovider";
	...
	private void checkColumns(String[] projection) {
		String[] available = { FeedTable.COLUMN_ID, FeedTable.COLUMN_TITLE,FeedTable.COLUMN_IMAGE_URL,FeedTable.COLUMN_DESCRIPTION };
		if (projection != null) {
